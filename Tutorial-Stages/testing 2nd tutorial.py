...
# --- Note Definitions ---
note_regions = {
    "Fa": (390, top_margin - 60, 410, bass_top_margin + 4 * line_spacing - 33),
    "Fa1": (745, top_margin - 60, 765, bass_top_margin + 4 * line_spacing - 33),
    "Sol": (1090, top_margin - 60, 1110, bass_top_margin + 4 * line_spacing - 33),
    "Sol1": (1445, top_margin - 60, 1465, bass_top_margin + 4 * line_spacing - 33)
}

# --- Note Order and Message Handling ---
note_order = ["Fa", "Fa1", "Sol","Sol1"]
current_note_index = 0
mess1 = canvas.create_text(900, 300, text="Bên phải nốt Mi là nốt Fa hay gọi là D", fill='black', font=("Lucida Sans", 30))
def handle_message():
    ...
    if current_note_index == 1:
        ...
        canvas.delete(mess1)
        mess1 = canvas.create_text(900, 300, text="Ngón út sẽ đặt trên nốt Sol hay gọi là E", fill='black', font=("Lucida Sans", 30))
    elif current_note_index == 3:
        canvas.delete(mess1)
        mess1 = canvas.create_text(900, 300, text="Ngón út sẽ đặt trên nốt Sol hay gọi là E", fill='black', font=("Lucida Sans", 30))
    elif current_note_index == 4:
        canvas.delete(mess1)
