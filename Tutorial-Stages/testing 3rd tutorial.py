...
# --- Note Definitions ---
note_regions = {
    "N1": (390, top_margin - 60, 410, bass_top_margin + 4 * line_spacing - 33),
    "N2": (440, top_margin - 60, 460, bass_top_margin + 4 * line_spacing - 33),
    "N3": (480, top_margin - 60, 500, bass_top_margin + 4 * line_spacing - 33),
    "N4": (520, top_margin - 60, 540, bass_top_margin + 4 * line_spacing - 33),
    "N5": (560, top_margin - 60, 580, bass_top_margin + 4 * line_spacing - 33),
    "N6": (600, top_margin - 60, 620, bass_top_margin + 4 * line_spacing - 33),
    "N7": (640, top_margin - 60, 660, bass_top_margin + 4 * line_spacing - 33),
    "N8": (680, top_margin - 60, 700, bass_top_margin + 4 * line_spacing - 33),
    "N9": (720, top_margin - 60, 740, bass_top_margin + 4 * line_spacing - 33),
    "N10": (760, top_margin - 60, 780, bass_top_margin + 4 * line_spacing - 33),
}

# --- Note Order and Message Handling ---
note_order = ["N1", "N2", "N3","N4", "N5", "N6","N7", "N8", "N9","N10"]
current_note_index = 0
mess1 = canvas.create_text(900, 300, text="Bạn hãy đánh tất cả các nốt trên đây", fill='black', font=("Lucida Sans", 30))
def handle_message():
    global mess1, current_note_index
    if current_note_index == 10:
        canvas.delete(mess1)
        mess1 = canvas.create_text(900, 300, text="Bạn đã chơi xong tất cả các nốt nốt! Bây giờ hãy thử lại", fill='black', font=("Lucida Sans", 30))
...
def midi_note():
    ...
    global note_number, current_note_index
...
# --- Main Program ---
sheet_music = [
    ('72', 56), ('74', 53), ('72', 50), ('74', 47),
    ('76', 44), ('77', 41), ('79', 38), ('77', 35),
    ('79', 32), ('76', 29)   
]
